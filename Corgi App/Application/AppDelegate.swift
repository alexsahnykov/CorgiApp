...
//  Corgi App
//
//  Created by Александр Сахнюков on 11/11/2018.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func launchBefore () {
        ...
        if launchedBefore  {
            rooVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "MainStoryboardID") as! UITabBarController
        } else {
